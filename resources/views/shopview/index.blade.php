                ...
                <div class="col-12 col-md-9">
                    ...
                    <div class="shop_toolbar_wrapper">
                        <div class="niceselect_option priceShortSelect">
                            ...
                            <a href="{{ url('/shopView/'.$shopId.'/price/DESC') }}" class="btn btn-primary" style="background-color:#082f83;"> low to high</a>
                            <a href="{{ url('/shopView/'.$shopId.'/price/ASC') }}" class="btn btn-primary" style="background-color:#082f83;">high to low</a>
                        </div>
